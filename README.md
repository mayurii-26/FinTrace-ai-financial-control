...
[![React](https://img.shields.io/badge/React-TypeScript-61DAFB.svg?style=flat&logo=react)](https://react.dev/)
[![Vite](https://img.shields.io/badge/Vite-Frontend-646CFF.svg?style=flat&logo=vite)](https://vite.dev/)
[![Supabase](https://img.shields.io/badge/Supabase-PostgreSQL-3ECF8E.svg?style=flat&logo=supabase)](https://supabase.com/)
[![OpenAI](https://img.shields.io/badge/OpenAI-AI%20Investigation-412991.svg?style=flat&logo=openai)](https://platform.openai.com/)
[![Razorpay](https://img.shields.io/badge/Razorpay-Test%20Mode-0B72E7.svg?style=flat&logo=razorpay)](https://razorpay.com/)
[![Pytest](https://img.shields.io/badge/Tests-115%2B%20Passed-success.svg?style=flat&logo=pytest)](https://pytest.org/)
...
4. [Core Operating Loop](#-core-operating-loop)
5. [What Makes FinTrace Different](#-what-makes-fintrace-different)
6. [System Architecture](#-system-architecture)
7. [Financial Lifecycle Trace](#-financial-lifecycle-trace)
8. [Deterministic Financial Control Engine](#-deterministic-financial-control-engine)
9. [AI Investigation Layer](#-ai-investigation-layer)
10. [Human-in-the-Loop Resolution](#-human-in-the-loop-resolution)
11. [Verification & Audit Trail](#-verification--audit-trail)
12. [Synthetic Dataset & Ground Truth](#-synthetic-dataset--ground-truth)
...
19. [Seed 600 Evaluation Records](#-seed-600-evaluation-records)
20. [Run Tests](#-run-tests)
21. [Judge Demo Flow](#-judge-demo-flow)
...
"WHERE DID THE FINANCIAL LIFECYCLE BREAK,
HOW MUCH MONEY IS EXPOSED,
WHY DID IT HAPPEN,
WHAT EVIDENCE SUPPORTS THE DIAGNOSIS,
WHAT SHOULD THE CONTROLLER DO,
AND DID THE CORRECTION ACTUALLY WORK?"

# 🚀 OUR SOLUTION

FinTrace combines a deterministic financial control engine
with an AI investigation layer.
...
only when the deterministic verification succeeds.
...
HIGH CONFIDENCE
        ↓
Recommendation can be presented clearly
...
The workflow does not stop at:

"AI says the issue is fixed."

It verifies the financial state again.
...
A successful verification is not based on the AI's opinion.

It is based on the deterministic financial state after the action.
...
The repository already contains .gitignore rules for environment secrets.
...
when you want to reset the existing synthetic dataset and generate a fresh evaluation batch.
...
## 0:45 – 1:20
### Open the Highest-Priority Exception
...
Status
1:20 – 1:50
Show Financial Lifecycle Trace
...
Point to the exact stage marked:
